...
VALUES (11111111, 'JUAN', 'PEREZ', 'M', 1, '1977/03/25', 'LOS PATOS 5855', 'CABA', 1,'juanperez@clinica.com', '1111111111', 2, 1),
(22222222, 'MARIO', 'CARRANZA', 'M', 1, '1971/07/05', 'ACASSUSO 8788', 'BUENOS AIRES', 2,'mariocarranza@clinica.com', '2222222222', 2, 1), 
(33333333, 'EZEQUIEL', 'MORENO', 'M', 2, '1963/11/15', 'AV MAIPU 5255', 'OLIVOS', 2,'ezequielmoreno@clinica.com', '3333333333', 2, 1),
(44444444, 'MARIA', 'ROMERO', 'F', 1, '1966/08/25', 'AV. RIVADAVIA 15525', 'RAMOS MEJIA', 2,'mariaromero@clinica.com', '4444444444', 2, 1),
(55555555, 'JUANA', 'MARTINEZ', 'F', 4, '1987/07/16', 'AV. CALLAO 560', 'CABA', 1,'juanamartinez@clinica.com', '5555555555', 2, 1),
(66666666, 'MARIANA', 'TRIDENTE', 'F', 1, '1978/11/23', 'AV. INDEPENDENCIA 845', 'CABA', 1,'marianatridente@clinica.com', '6666666666', 2, 1),
(77777777, 'RAMIRO', 'RAMIREZ', 'M', 3, '1980/04/15', 'AV. MITRE 5478', 'MUNRO', 2,'ramiroramirez@clinica.com', '7777777777', 1, 1),
(88888888, 'CAROLINA', 'CASTRO', 'F', 1, '1985/09/11', 'SAN LORENZO 5855', 'OLIVOS', 2,'carolinacastro@clinica.com', '8888888888', 1, 1) 
...
-- TABLA USUARIOS
INSERT INTO USUARIOS (DNI, CONTRASENIA, ESTADO) 
VALUES (11111111,'1111',1),
(22222222,'2222',1),
(33333333,'3333',1),
(44444444,'4444',1),
(55555555,'5555',1),
...
CREATE PROCEDURE SP_LISTARMEDICOS()
	SELECT EMPLEADOS.DNI, EMPLEADOS.NOMBRE, EMPLEADOS.APELLIDO, EMPLEADOS.SEXO, EMPLEADOS.COD_NACIONALIDAD AS COD_NACIONALIDAD, EMPLEADOS.DESCRIPCION AS NACIONALIDAD, EMPLEADOS.FECHA_NAC, EMPLEADOS.DIRECCION, EMPLEADOS.LOCALIDAD, EMPLEADOS.PROVINCIA AS COD_PROV, EMPLEADOS.DESCRIPCION, EMPLEADOS.EMAIL, EMPLEADOS.TELEFONO, EMPLEADOS.ESTADO, EMPLEADOS.COD_TIPOSUSUARIO, ESPECIALIDAD.CODIGO, ESPECIALIDAD.DESCRIPCION, DIASEMANA.DESCRIPCION, MEDICO_POR_ESPECIALIDAD.HORAINICIO, MEDICO_POR_ESPECIALIDAD.HORAFIN 
	FROM EMPLEADOS AS E
